...
extern volatile uint8_t debug_tx_finish;
extern volatile uint8_t debug_rx_finish;
/*********************
 * 对外函数API
**********************/
...
extern void DebugUsart_Tx(uint8_t *pdata, uint16_t sz);
extern void DebugUsart_Rx(uint8_t *pdata, uint16_t sz);
#endif
